...
public class Day2_PuzzleTests
{
    ...
    public void Part1_Validate_IsPossible(bool expected, string game)
    {
    ...
    public void Result_Part2_Validation()
    {
        ...
        var result = Day2.Calculate_Part2(inputs);
    ...
    public void Part2_Validate_IsPossible(int expected, string game)
    {
        Assert.Equal(expected, Day2.ConvertInput(game).CubesMultiplied);
    }
}